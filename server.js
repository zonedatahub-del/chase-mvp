...
// ── Silence the MemoryStore warning before requiring express-session ──
...
process.emitWarning = emitWarning; // restore
...
app.post('/login', (req, res) => {
  ...
  if (email && email.toLowerCase().trim() === USER.email && password === USER.password) {
